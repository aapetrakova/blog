...
|-----------------|-------------|----------------------|
| ![Главная](sreen/главная.png) | ![Регистрация](screen/регистрация.png) | ![Профиль](screen/profile.png) |

| Новый пост | Просмотр поста | Редактирование профиля |
|------------|----------------|------------------------|
| ![Новый пост](screen/новый_пост.png) | ![Пост](screen/пост.png) | ![Редактирование профиля](screen/редактирование_профиля.png) |
